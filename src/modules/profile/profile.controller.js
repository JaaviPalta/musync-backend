import { getProfileByUserId, upsertProfile, getPublicProfile } from './profile.service.js';
...
export async function updateProfileController(req, res, next) {
  try {
    ...
    return res.status(200).json({ data: profile, message: 'Perfil actualizado correctamente' });
  } catch (error) {
    return next(error);
  }
}
